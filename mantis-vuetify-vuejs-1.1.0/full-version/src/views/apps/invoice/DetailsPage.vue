...
import { DownloadOutlined, EditOutlined, PrinterFilled, ShareAltOutlined } from '@ant-design/icons-vue';
import LogoMain from '@/layouts/dashboard/logo/LogoMain.vue';

// theme breadcrumb
const page = ref({ title: 'Invoice Summary' });
  ...
  <v-row>
    <v-col cols="12">
      <v-card variant="outlined" class="bg-surface">
        <v-card-item>
          <div class="bg-lightprimary text-right pa-2 rounded-md">
            <v-btn variant="text" icon rounded>
              <EditOutlined />
            </v-btn>
            <v-btn variant="text" icon rounded>
              <DownloadOutlined />
          ...
          <v-row class="mt-6">
            <v-col cols="12" sm="6">
              <div class="d-flex">
                <LogoMain />
                <v-chip color="success" variant="outlined" class="ml-2" label size="small">Paid</v-chip>
              </div>
              <p class="text-h6 text-lightText">8795646525451</p>
            </v-col>
            <v-col cols="12" sm="6">
              <div class="d-flex justify-end">
                <h6 class="text-subtitle-1 mr-2 mb-0">Date</h6>
                <p class="text-h6 text-lightText mb-0">01/05/2023</p>
              </div>
              <div class="d-flex justify-end">
                <h6 class="text-subtitle-1 mr-2 mb-0">Due Date</h6>
                <p class="text-h6 text-lightText mb-0">17/07/2023</p>
              </div>
            </v-col>
            <v-col cols="12" sm="6">
              ...
              <v-table class="bordered-table" hover>
                <thead class="bg-containerBg">
                  <tr>
                    ...
                    <th class="text-left text-uppercase text-caption font-weight-bold">Name</th>
                    <th class="text-left text-uppercase text-caption font-weight-bold">Description</th>
                    <th class="text-left text-uppercase text-caption font-weight-bold" style="width: 100px">Qty</th>
                    <th class="text-left text-uppercase text-caption font-weight-bold" style="width: 100px">Price</th>
            ...
            <v-divider></v-divider>
            <v-col cols="12" sm="5" md="4" class="ml-auto">
