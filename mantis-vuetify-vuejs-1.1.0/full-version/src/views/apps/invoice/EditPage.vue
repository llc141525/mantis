              ...
              <v-table class="bordered-table" hover>
                ...
                <tbody>
                  <tr class="text-lighttext" v-for="(item, index) in tableData" :key="index">
                    ...
                    <td class="text-subtitle-1 font-weight-regular py-3 text-right">${{ item.amount }}</td>
                      ...
                      <v-card-text class="pb-8">
                        <v-row class="mt-6">
                          <v-col cols="12" sm="6">
                            <div class="d-flex">
                              <LogoMain />
                              <v-chip color="success" class="ml-2" label size="small">Paid</v-chip>
                            </div>
