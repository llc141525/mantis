  ...
  <v-row>
          ...
          <v-card-text>
            <v-row>
              ...
              <v-col cols="12" md="6">
                ...
                <v-text-field color="primary" single-line variant="outlined" aria-label="language" hide-details v-model="textLanguage">
                </v-text-field>
              </v-col>
              <v-col cols="12" md="6">
    ...
    <v-col cols="12">
        ...
        <v-card-text class="pa-0">
          <v-list lines="two" aria-label="session list" aria-busy="true">
            <v-list-item v-for="(activeSession, i) in activeSessions" :key="i" color="primary" border>
              ...
              <template v-slot:append>
                <v-btn variant="text" color="primary" class="ml-4"> Logout </v-btn>
              </template>
            </v-list-item>
          </v-list>
        </v-card-text>
      ...
      <div class="text-right mt-6">
        <v-btn color="secondary" variant="outlined" class="mr-3">Cancel</v-btn>
