...
// icons
import { UserOutlined, FileTextOutlined, CreditCardOutlined, KeyOutlined } from '@ant-design/icons-vue';
        ...
        <v-card variant="outlined">
          ...
          <div class="my-3">
            <v-row class="d-flex flex-row">
              <v-col cols="12" sm="4" class="border-sm-right pr-sm-0 py-sm-0">
                <v-card-text>
                  <v-tabs v-model="tab" direction="vertical" color="primary">
                    ...
                    <v-tab value="tab-billing" rounded="md" class="text-left overflow-hidden" height="70">
                      <FileTextOutlined class="v-icon--start" />
                      <div>
                        <div>Billing</div>
                    ...
                    <v-tab value="tab-payment" rounded="md" class="text-left overflow-hidden" height="70">
                      <CreditCardOutlined class="v-icon--start" />
                      <div>
                        <div>Payment</div>
                    ...
                    <v-tab value="tab-change-password" rounded="md" class="mb-3 text-left overflow-hidden" height="70">
                      <KeyOutlined class="v-icon--start" />
                      <div>
          ...
          <div class="pa-6 text-right">
            <v-btn color="primary" variant="flat">Continue</v-btn>
          </div>
        </v-card>
      </v-card>
    </v-col>
