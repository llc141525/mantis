...
// icons
import { SearchOutlined, EllipsisOutlined, MessageFilled, StopOutlined } from '@ant-design/icons-vue';
            ...
            <v-card variant="outlined" class="card-hover-border bg-containerBg">
              <v-card-text>
                ...
                <div class="d-flex ga-4 mt-5">
                  ...
                  <v-btn variant="outlined" color="error" class="flex-fill" prepend-icon="$blockHelper">
                    <template v-slot:prepend>
                      <StopOutlined />
                    </template>
                    Block
