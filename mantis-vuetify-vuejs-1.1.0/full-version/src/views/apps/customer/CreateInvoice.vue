      ...
      <UiParentCard title="Create Invoice">
        ...
        <v-row>
          ...
          <v-col cols="12" md="6">
            ...
            <v-select color="primary" :items="status" role="link" variant="outlined" v-model="textstatus" hide-details> </v-select>
          </v-col>
        </v-row>
        ...
        <div class="text-right">
          <v-btn color="primary" variant="flat">Add Invoice</v-btn>
        </div>
      </UiParentCard>
    </v-col>
  </v-row>
