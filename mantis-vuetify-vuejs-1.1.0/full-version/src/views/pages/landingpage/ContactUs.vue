                ...
                <v-checkbox-btn color="primary" class="checkboxLabel" hide-details v-model="checked">
                  <template v-slot:label>
                    <p class="mb-0 text-h6">
                      ...
                      <router-link to="/pages/contact-us" class="mx-1 text-primary text-decoration-none"> Privacy Policy </router-link> and
                      <router-link to="/pages/contact-us" class="mx-1 text-primary text-decoration-none"> Cookie Policy</router-link>
                    </p>
                  </template>
                </v-checkbox-btn>
              </v-col>
