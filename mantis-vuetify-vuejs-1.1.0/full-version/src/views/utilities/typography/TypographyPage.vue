      ...
      <v-row>
        <v-col cols="12">
          <UiParentCard title="Basic">
            ...
            <v-breadcrumbs :items="['Regular', 'Medium', 'Bold']" class="text-h6 text-lightText flex-wrap mb-0 pa-0"></v-breadcrumbs>
          </UiParentCard>
        </v-col>
        <v-col cols="12">
          <UiParentCard title="Heading">
            ...
            <v-breadcrumbs
              ...
              class="text-h6 text-lightText flex-wrap mb-0 pa-0"
            ></v-breadcrumbs>
          </UiParentCard>
        </v-col>
        <v-col cols="12">
