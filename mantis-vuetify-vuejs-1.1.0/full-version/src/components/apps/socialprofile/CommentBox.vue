    ...
    <div class="d-flex ga-4 align-center">
      ...
      <v-menu>
        <template v-slot:activator="{ props }">
          <v-btn icon size="small" variant="text" color="secondary" class="ml-auto" rounded v-bind="props"><MoreOutlined /></v-btn>
        </template>
    ...
    <div v-for="reply in comments?.data.replies" :key="reply.name">
      <v-card variant="flat" elevation="0" class="bg-gray100 mb-3 pa-5">
        <div class="d-flex ga-4 align-center">
          ...
          <v-menu>
            <template v-slot:activator="{ props }">
              <v-btn icon size="small" rounded variant="text" color="secondary" class="ml-auto" v-bind="props"><MoreOutlined /></v-btn>
            </template>
