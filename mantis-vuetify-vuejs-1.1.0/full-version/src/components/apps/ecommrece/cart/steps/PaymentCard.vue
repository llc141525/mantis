            ...
            <v-card-item class="py-3 px-0">
              ...
              <v-row class="mb-md-n3 mb-n1">
                ...
                <v-col cols="12" class="text-right">
                  <v-btn variant="outlined" class="mr-2" color="secondary">Cancel</v-btn>
                    ...
                    <v-card-text class="top-object">
                      ...
                      <div class="d-flex align-center justify-space-between mt-3">
                        <div class="d-flex align-center">
                          <span class="text-medium-emphasis text-caption opacity-50 mr-2">CVV</span>
                          <span class="text-caption d-block">760</span>
                        </div>
                        <div class="d-flex align-center">
                          <span class="text-medium-emphasis text-caption opacity-50 mr-2">Expire Date</span>
